...
| [`standar-performa-dan-keamanan.md`](standar-performa-dan-keamanan.md) | Peta ke OWASP Top 10 / ASVS / Secure Headers, ISO 27001 Annex A, NIST SSDF, dan Core Web Vitals — beserta sembilan celah bernomor, tujuh ditutup dan dua terbuka ([ADR-0028](../adr/0028-jangkar-standar-performa-dan-keamanan.md)) |
