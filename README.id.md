...
| `bun test`               | 21 berkas gerbang: kontrak `awcms`, peran situs, tanpa backend, kosakata `news`, feed, penyaji, CSP keluaran, cermin terjemahan |
...
`<nama>.id.md` adalah cerminnya, dan ia mencatat hash Inggris yang
diterjemahkannya ([ADR-0039](docs/adr/0039-english-is-the-source-language.md)).
`bun run audit:translation` gagal saat sebuah cermin basi, dan menghitung
dokumen yang masih menunggu cerminnya. Sumber berkas ini
[`README.md`](README.md).
